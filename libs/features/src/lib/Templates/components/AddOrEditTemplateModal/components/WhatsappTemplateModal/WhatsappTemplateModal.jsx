...
import styles from "./WhatsappTemplateModal.module.scss";
...
const WhatsappTemplateModal = ({
	...
	return (
		<div className={styles.whatsappTemplateModal}>
			<h3>{TEMPLATES_TRANSLATION.Whatsapp_Template[user?.language?.toUpperCase()]}</h3>
