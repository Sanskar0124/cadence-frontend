				...
				<div className={styles.main}>
					<div className={styles.col1}>
						...
						<div className={styles.group}>
							...
							<div className={styles.text}>
								{modal?.account?.name ?? modal?.Account?.name ?? <span>NA</span>}
							</div>
						</div>
						<div className={styles.group}>
							<label>
							...
							<div className={styles.text}>
								{modal?.account?.country ?? modal?.Account?.country ?? <span>NA</span>}
							</div>
						</div>
						<div className={styles.group}>
							<label>
							...
							<div className={styles.text}>
								{modal?.account?.url ?? modal?.Account?.url ?? <span>NA</span>}
							</div>
						</div>
						<div className={styles.group}>
							<label>
							...
							<div className={styles.text}>
								{modal?.account?.size ?? modal?.Account?.size ?? <span>NA</span>}
							</div>
						</div>
						<div className={styles.group}>
							<label>
							...
							<div className={styles.text}>
								{modal?.account?.phone_number ?? modal?.Account?.phone_number ?? (
									<span>NA</span>
								)}
							</div>
						</div>
