...
import LinkLeadsModal from "../components/LeadDetailsModal/LeadDetailsModal";
...
const CRMCadenceImport = () => {
	...
	useEffect(() => {
		if (importFrom === "csv" || type === "create_lead" || isProspecting === "false") {
	...
	return (
		<PageContainer className={styles.pageContainer}>
			<div className={styles.header}>
				...
				/>
				{(importFrom === "csv" || type === "create_lead") &&
					!importError?.error &&
					!importLoading &&
					!isAdding &&
					!isAddSuccess && (
...
export default CRMCadenceImport;
