				...
				<div className={styles.main}>
					<div className={styles.col1}>
						...
						<div className={styles.group}>
							...
							<div className={styles.text}>
								{modal?.Account?.country?.length > 0 ? (
									modal?.Account?.country
								) : (
									<span>NA</span>
								)}
							</div>
						...
						<div className={styles.group}>
							<label>
								{TASKS_TRANSLATION.COMPANY_LINKEDIN_URL[user?.language?.toUpperCase()]}
							</label>
							<div className={styles.text}>
								{modal?.Account?.linkedin_url?.length > 0 ? (
									modal?.Account?.linkedin_url
								) : (
									<span>NA</span>
								)}
							</div>
						...
						<div className={styles.group}>
							...
							<div className={styles.text}>
								{modal?.Account?.phone_number?.length > 0 ? (
									modal?.Account?.phone_number
								) : (
									<span>NA</span>
								)}
							</div>
