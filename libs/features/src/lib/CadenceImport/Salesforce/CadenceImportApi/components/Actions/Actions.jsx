...
import { DATA_CATEGORY, DATA_CATEGORY_ID, LEAD_STATUS } from "../../../constants";
			...
			<div className={styles.actions}>
				...
				<div className={styles.right}>
					...
					<ThemedButton
						onClick={() =>
							list.filter(
								lead => checkedLeads.includes(lead.Id) && lead?.status === LEAD_STATUS
							).length
