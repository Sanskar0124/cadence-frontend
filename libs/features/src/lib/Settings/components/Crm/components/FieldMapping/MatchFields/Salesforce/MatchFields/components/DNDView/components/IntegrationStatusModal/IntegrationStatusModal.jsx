...
import { MinusOutline, Plus, Trash, TrashGradient } from "@cadence-frontend/icons";
import { ThemedButtonThemes } from "@cadence-frontend/themes";
import { Input, Label, Select, ThemedButton, Toggle } from "@cadence-frontend/widgets";
...
const IntegrationStatusModal = ({
	...
	const addReason = () => {
		...
		// 	)
		// )
		// 	return addError("Cannot add duplicate Reason");
	...
	const onDefaultIntChange = () => {
		setDefaultIntStatus(
			defaultIntStatus === VIEWS.CONTACT ? VIEWS.ACCOUNT : VIEWS.CONTACT
		);
	};
