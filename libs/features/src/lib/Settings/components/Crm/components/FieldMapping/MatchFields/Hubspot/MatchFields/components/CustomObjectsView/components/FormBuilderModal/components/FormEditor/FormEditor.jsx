			...
			case "textarea":
				return (
					<>
						...
						<Input
							placeholder={`${
								COMMON_TRANSLATION.TYPE_HERE[user?.language.toUpperCase()]
							}`}
							disabled
							type="textarea"
							height="70px"
		...
		<div className={styles.main}>
			<div className={styles.header}>
				...
				<div className={styles.instruction}>
					...
					{SETTINGS_TRANSLATION.SET_MAX_SLOTS[user?.language.toUpperCase()]}
				</div>
			</div>
			...
			<div className={`${styles.body}`}>
				...
				{availableHSFields[VIEWS.CONTACT].length +
					availableHSFields[VIEWS.COMPANY].length !==
					0 && (
					<div className={styles.button}>
						...
						>
							...
							{COMMON_TRANSLATION.SECTION[user?.language.toUpperCase()]}
						</ThemedButton>
					</div>
				)}
			</div>
