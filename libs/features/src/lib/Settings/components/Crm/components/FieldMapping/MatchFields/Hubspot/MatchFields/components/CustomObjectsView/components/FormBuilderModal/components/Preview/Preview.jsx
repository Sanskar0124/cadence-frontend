		...
		>
			<div className={styles.heading}>
				...
				<div className={styles.back}>
					<BackButton
						text={`${SETTINGS_TRANSLATION.FORM_EDITOR[user?.language.toUpperCase()]}`}
						onClick={() => {
							onClose();
						}}
					/>
													...
													>
														...
														{item.type === "radio_button" && (
															<div className={styles.radioBox}>
																<div className={styles.label}>{item.hubspot_label}?</div>
			...
			<div className={styles.buttonSave}>
				<ThemedButton
					...
					onClick={() => handleSave()}
				>
					{SETTINGS_TRANSLATION.SAVE_AND_EXIT_FROM[user?.language.toUpperCase()]}
				</ThemedButton>
			</div>
		</Modal>
	);
