...
import { ALPHABETS, ACCOUNTS_CONTACTS, ACCOUNTS_LEADS } from "./constants";
	...
	return (
		<div className={styles.main}>
			<div className={styles.header}>
				...
				{(buildFormFor === VIEWS.CONTACT || buildFormFor === VIEWS.LEAD) &&
					buildFormFor !== VIEWS.CANDIDATE && (
						<div className={styles.tabNavBox}>
							<TabNavSlider
								theme={TabNavThemes.GREY}
								buttons={
									buildFormFor === VIEWS.CONTACT ? ACCOUNTS_CONTACTS : ACCOUNTS_LEADS
								}
