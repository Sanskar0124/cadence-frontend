...
import HubspotFields from "./components/HubspotFields/Hubspot";
	...
	const handleDrag = result => {
		...
		if (result.source.droppableId === "hs") {
			...
			let obj = {
				...
				hubspot_field: data.name,
				hubspot_endpoint: data.hubspot_endpoint,
				hubspot_label: data.label,
				editable: data.editable,
			};
			if (data.type === "select" || data.type === "radio") {
				obj.type = "dropdown";
				obj.possible_values = data.picklist_values;
			} else if (data.type === "booleancheckbox") {
			...
			<div className={styles.main}>
				...
				<DragDropContext onDragEnd={result => handleDrag(result)}>
					<div className={styles.body}>
						...
						/>
						<HubspotFields availableHSFields={availableHSFields} loading={loading} />
					</div>
				</DragDropContext>
			</div>
		</Modal>
