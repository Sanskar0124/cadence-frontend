...
const QuickView = ({
	...
	const [sellsyFields, setSellsyFields] = useState(FIELDS);
		...
		<div className={`${styles.quickView} `}>
				...
				<div className={styles.phoneInfo}>
					<div className={styles.primaryPhone}>
						...
						>
							...
							{COMMON_TRANSLATION.PHONE_NUMBER[user?.language?.toUpperCase()]}
						</HoverContainer>
						<HoverContainer
							className={styles.hoverContainer + " " + styles.dropDown}
							hoverStyles={styles.hover}
			...
			{testFieldsCustomObjectModal && (
				<TestFieldsCustomObjectModal
					...
					fields={sellsyFields}
					setFields={setSellsyFields}
					url={url}
					setUrl={setUrl}
				/>
			)}

			{Object.keys(sellsyFields[VIEWS.CONTACT]).length !== 0 && (
