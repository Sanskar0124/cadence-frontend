...
const QuickView = ({
	...
	const [salesforceFields, setSalesforceFields] = useState(FIELDS);
		...
		<div className={`${styles.quickView} `}>
			...
			<div className={styles.body}>
				...
				<div className={styles.customVariable}>
					<HoverContainer
						...
						setCurrentlyHovered={setCurrentlyHovered}
						currentlyHovered={currentlyHovered}
						disableHover={!QUICKVIEW_FIELDS.VARIABLE1.hoversFor.includes(currentView)}
						hoverValue={QUICKVIEW_FIELDS.VARIABLE1}
					>
						<Variable color={Colors.lightBlue} /> &nbsp; Variable 1
					</HoverContainer>
					...
					<HoverContainer
						...
						setCurrentlyHovered={setCurrentlyHovered}
						currentlyHovered={currentlyHovered}
						disableHover={!QUICKVIEW_FIELDS.VARIABLE2.hoversFor.includes(currentView)}
						hoverValue={QUICKVIEW_FIELDS.VARIABLE2}
					>
						<Variable color={Colors.lightBlue} /> &nbsp; Variable 2
					</HoverContainer>
					...
					<HoverContainer
						...
						setCurrentlyHovered={setCurrentlyHovered}
						currentlyHovered={currentlyHovered}
						disableHover={!QUICKVIEW_FIELDS.VARIABLE3.hoversFor.includes(currentView)}
						hoverValue={QUICKVIEW_FIELDS.VARIABLE3}
					>
						<Variable color={Colors.lightBlue} /> &nbsp; Variable 3
					</HoverContainer>
				</div>
				<div className={styles.customVariable}>
					<HoverContainer
						...
						setCurrentlyHovered={setCurrentlyHovered}
						currentlyHovered={currentlyHovered}
						disableHover={!QUICKVIEW_FIELDS.VARIABLE4.hoversFor.includes(currentView)}
						hoverValue={QUICKVIEW_FIELDS.VARIABLE4}
					>
						<Variable color={Colors.lightBlue} /> &nbsp; Variable 4
					</HoverContainer>
					...
					<HoverContainer
						...
						setCurrentlyHovered={setCurrentlyHovered}
						currentlyHovered={currentlyHovered}
						disableHover={!QUICKVIEW_FIELDS.VARIABLE5.hoversFor.includes(currentView)}
						hoverValue={QUICKVIEW_FIELDS.VARIABLE5}
					>
						<Variable color={Colors.lightBlue} /> &nbsp; Variable 5
					</HoverContainer>
				</div>
			</div>
			...
			{testFieldsCustomObjectModal && (
				<TestFieldsCustomObjectModal
					...
					setFields={setSalesforceFields}
					url={url}
					setUrl={setUrl}
				/>
			)}

			{Object.keys(salesforceFields[buildFormFor]).length !== 0 && (
