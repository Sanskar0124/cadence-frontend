	...
	const handleDrag = result => {
		...
		if (result.source.droppableId === "zf") {
			...
			let obj = {
				...
				bullhorn_field: data.name,
				bullhorn_endpoint: data.sobject,
				bullhorn_label: data.label,
				editable: data.editable,
			};
			if (data.type === "SELECT" && data.multiValue === false) {
				obj.type = "dropdown";
				...
				data.type === "SELECT" &&
				Object.keys(data).includes("multiValue") &&
