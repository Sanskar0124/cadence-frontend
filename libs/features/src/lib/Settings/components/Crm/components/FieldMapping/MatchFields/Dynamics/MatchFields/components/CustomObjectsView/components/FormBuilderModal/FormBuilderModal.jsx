...
import DynamicsFields from "./components/DynamicsFields/DynamicsFields";
...
const FormBuilderModal = ({
	...
	const handleDrag = result => {
		...
		if (result.source.droppableId === "sf") {
			...
			let obj = {
				...
				dynamics_field: data.name,
				dynamics_endpoint: data.dynamics_endpoint,
				dynamics_label: data.label,
		...
		} else if (result.destination.droppableId === "sf") {
