...
import { Goto, CopyBlank, Pipedrive } from "@cadence-frontend/icons";
		...
		>
			<div className={styles.header}>
				<div className={styles.pipedrive}>
					{" "}
					<Pipedrive color={Colors.white} size="2rem" />
				</div>
				<div className={styles.msg}>Form successfully completed</div>
				<p className={styles.headTo}>Head over to Pipedrive to see the changes</p>
			</div>
