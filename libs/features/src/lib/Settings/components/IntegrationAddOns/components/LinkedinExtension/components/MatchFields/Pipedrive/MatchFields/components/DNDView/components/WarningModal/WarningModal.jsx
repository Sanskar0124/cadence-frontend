...
const WarningModal = ({ modal, setModal }) => {
	...
	return (
		<Modal
			onClose={() => onClose()}
			isModal={[...modal[VIEWS.PERSON], ...modal[VIEWS.ORGANIZATION]].length !== 0}
		...
		>
			...
			<div className={styles.footer}>
				{[...modal[VIEWS.PERSON], ...modal[VIEWS.ORGANIZATION]].length !== 0 && (
					<div>
						<div className={styles.warningType}>Organizations {"&"} Persons</div>
						<div className={styles.fields}>
							{[...modal[VIEWS.PERSON], ...modal[VIEWS.ORGANIZATION]].map(item => (
