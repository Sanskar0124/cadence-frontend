...
import { Goto, CopyBlank, SalesforceCloud } from "@cadence-frontend/icons";
		...
		>
			<div className={styles.header}>
				<div className={styles.salesForce}>
					{" "}
					<SalesforceCloud color={Colors.white} />
				</div>
				<div className={styles.msg}>Form successfully completed</div>
				<p className={styles.headTo}>Head over to Salesforce to see the changes</p>
			</div>
