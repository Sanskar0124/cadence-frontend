...
import { useCadence, useCadenceImportGoogleSheets } from "@cadence-frontend/data-access";
import { Close, ErrorGradient, Refresh2 } from "@cadence-frontend/icons";
					...
					<div className={styles.workspace}>
						<DragDropContext onDragEnd={e => handleDragEnd(e)}>
							...
							<ExtractedColumns
								...
								extractColumnsLoading={headersLoading}
							/>
						</DragDropContext>
					</div>
				</div>
