...
export const DEFAULT_COLUMNS = type =>
	[
		{
			uid: "__first_name",
			label: "First Name",
		...
		...(type === IMPORT_TYPE.SHEETS
			? [
					{
						uid: "__owner_integration_id",
						label: "User GSheets ID",
						value: { name: null },
						backendField: "owner_integration_id",
						required: true,
					},
					{
						...
						label: "Lead ID",
						value: { name: null },
						backendField: "lead_id",
						required: true,
					},
					{
						uid: "__integration_id",
						label: "Integration ID",
						value: { name: null },
						backendField: "integration_id",
						required: true,
					},
			  ]
			: []),
...
export const POTENTIAL_FIELDS = {
	...
	owner_integration_id: ["User GSheets ID", "User Integration ID", "User Excel ID"],
	lead_id: ["Lead ID"],
