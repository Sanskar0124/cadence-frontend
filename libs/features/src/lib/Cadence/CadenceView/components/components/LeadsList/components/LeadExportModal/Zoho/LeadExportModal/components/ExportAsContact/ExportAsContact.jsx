			...
			case "input_box":
				return (
					<>
						<Label
							required={
								item.integration_label === "Last_Name" ||
								item.integration_label === "First_Name"
							}
						>
								...
								(item.type === "advanced_dropdown" ? (
									<div className={styles.inputGroup}>
										...
										<AdvanceSelect
											...
											options={zohoAccounts}
											setOptions={setZohoAccounts}
											loading={searchZohoAccountsLoading}
